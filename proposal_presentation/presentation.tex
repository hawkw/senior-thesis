...
\begin{itemize}
    \item Mnemosyne is a functional systems programming language with compile-time automatic memory~management.
...
\textbf{Mnemosyne is inspired by:}
    \begin{itemize}
        ...
        \item\textbf{Haskell and ML}'s type system~\cite{jones2003haskell,hudak1992gentle} and pattern matching~\cite{jones2003haskell,maranget2007warnings,Krishnaswami:2009:FPM:1594834.1480927}
