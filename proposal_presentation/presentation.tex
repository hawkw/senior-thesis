...
\begin{itemize}
    \item \textbf{Combinator parsing}~\cite{Danielsson:2010:TPC:1932681.1863585,frost2008parser,swierstra2001combinator} using \texttt{combine} and \texttt{combine-language}
