...
% ch:relatedwork
\include{chapters/ch02_relatedwork} % Background, literature survey, ...

% ch:method
\include{chapters/ch03_methodofapproach} % Chapter organization is topic-dependent
...
%ch:conclusion
\include{chapters/ch05_conclusion} % Conclusion/future work
...
\begin{spacing}{1}
\bibliography{bibliography/sample}    % File type ".bib" is assumed
