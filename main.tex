...
\newminted[inlinerust]{rust}{ fontfamily = lmtt
                            , linenos = true
...
\newminted[inlinelisp]{lisp}{ fontfamily = lmtt
                            , linenos = true
                            , numberblanklines=true
                            , mathescape = true
                            , fontsize = \footnotesize
...
% ch:intro
\include{chapters/ch01_overview} % Introduction -- of course, you can name it anything!

% ch:relatedwork
\include{chapters/ch02_background} % Background, literature survey, ...

% ch:design
\include{chapters/ch03_design} % Chapter organization is topic-dependent

%ch:implem
\include{chapters/ch04_implementation} % Chapter organization is topic-dependent

%ch:eval
\include{chapters/ch05_evaluation} % Chapter organization is topic-dependent

%ch:conclusion
\include{chapters/ch06_conclusion} % Conclusion/future work
